...
from handlers.actions_handlers import router as actions_router
from handlers.errors_handler import router as errors_router
from handlers.registration_handlers import router as registration_router
...
async def main():
    ...
    dispatcher.include_routers(base_router, actions_router, errors_router, registration_router, balance_router)
